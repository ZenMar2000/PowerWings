...
namespace ND_VariaBULLET
{
    ...
    public abstract class FireBase : MonoBehaviour
    {
        ...
        private Func<bool>[] fireMethods = new Func<bool>[5];
        ...
        public virtual void LateUpdate()
        {
            ...
            if (fireCommanded && (ShootAtCurrentInterval() || (int)controller.FireCommand == 4))
            {
                InstantiateShot();
        ...
        protected abstract bool ScriptFire();
